        ...
        <main class="flex-1 p-6 bg-white overflow-y-auto">
            ...
            <form action="{{ route('supplier.store') }}" method="POST" class="bg-gray-50 p-6 rounded shadow space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_supp" id="nama_supp" class="w-full border border-gray-300 rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500" required>
                </div>

                <div>
                    <label for="kontak" class="block text-sm font-medium text-gray-700">Kontak</label>
                    <input type="text" name="kontak" id="kontak" class="w-full border border-gray-300 rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500">
                </div>

                <div>
                    <label for="alamat" class="block text-sm font-medium text-gray-700">Alamat</label>
                    <textarea name="alamat" id="alamat" class="w-full border border-gray-300 rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500"></textarea>
                </div>
