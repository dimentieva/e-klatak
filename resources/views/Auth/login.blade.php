...
<body class="bg-[#e0f7fa] flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white w-full max-w-3xl rounded-2xl box-shadow overflow-hidden md:flex">
        <!-- Left -->
        <div class="hidden md:flex md:w-1/2 flex-col items-center justify-center bg-white p-8">
            <img src="{{ asset('eklatak.png') }}" class="w-40 h-40 object-contain mb-4" />
            <h1 class="text-3xl font-bold text-[#0bb4b2] text-center">E-Klatak</h1>
            <p class="text-sm text-gray-600 text-center">Point Of Sales Application</p>
        </div>
    ...
    <script>
        function togglePassword() {
            ...
            const open2 = document.getElementById('eyeOpen2');

            if (input.type === "password") {
                input.type = "text";
                icon.innerHTML = `
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.458-4.042m3.208-2.24A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.956 9.956 0 01-1.334 2.472M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M3 3l18 18" />`;
            } else {
                input.type = "password";
