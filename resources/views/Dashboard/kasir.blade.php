...
<div class="flex flex-col-reverse lg:flex-row bg-gray-50 min-h-[calc(100vh-100px)]">
    ...
    <div class="lg:basis-2/5 w-full bg-white border-t lg:border-t-0 lg:border-r p-4 sm:p-6 flex flex-col shadow-md rounded-b-xl lg:rounded-tr-xl lg:rounded-br-xl max-h-screen overflow-y-auto">
        ...
        <div class="mt-auto space-y-4">
            <div class="text-center bg-gray-100 p-4 rounded-xl text-lg font-semibold text-gray-700 shadow-inner">
                Grand Total: <span id="grandTotal" class="text-[#0BB4B2] font-bold">Rp 0</span>
            </div>
    ...
    <div class="lg:basis-3/5 w-full bg-white p-4 sm:p-6 overflow-auto shadow-inner flex flex-col">
        ...
        <div class="flex gap-2 mb-4 flex-wrap">
            ...
            <button onclick="filterKategori('{{ $kat->id }}')" class="px-4 py-2 rounded-full kategori-button text-sm bg-gray-200 text-gray-700 hover:bg-[#0BB4B2] hover:text-white transition shadow-sm" data-id="{{ $kat->id }}">
                {{ $kat->name }}
            </button>
            @endforeach
        </div>
