...
<div x-data="{ sidebarOpen: false }" class="min-h-screen flex flex-col md:flex-row">
    ...
    <!-- Sidebar -->
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed z-30 inset-y-0 left-0 w-64 bg-[#0BB4B2] text-white transform transition-transform duration-200 ease-in-out md:translate-x-0 md:static md:inset-0 flex flex-col p-4 justify-between">
        <div>
            <!-- Logo -->
    ...
    <!-- Overlay -->
    <div x-show="sidebarOpen" @click="sidebarOpen = false" class="fixed inset-0 bg-black bg-opacity-40 z-20 md:hidden"></div>
